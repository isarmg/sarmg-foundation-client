...
impl SecureHttpClient {
    ...
    /// Desktop/mobile Client delivery selects only PublicHttps or the debug-only
...
pub fn client_network_policy(url: &Url) -> Result<NetworkPolicy, Error> {
