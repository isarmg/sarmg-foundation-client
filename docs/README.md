...
本文档集描述当前 `0.9.13` 源码。Foundation 提供产品中立的 Client 机制；业务协议、产品状态和用户界面
...
| [Client identity](client-identity.md) | 运行身份、凭据快照及 Host 采用方式 |
...
| [拆分来源](split-origin.md) | 仓库拆分的来源与非兼容承诺 |
